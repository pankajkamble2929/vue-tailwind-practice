...
<nav class="flex flex-row gap-4 justify-center border-2 border-y-slate-200">
  ...
  <div class="basis-1/4 pt-6 space-x-7">
    <a class="p-2 hover:bg-slate-200 hover:rounded" href="/#features">Features</a>
    <a class="p-2 hover:bg-slate-200 hover:rounded" href="/#testimoni">Testimonials</a>
    <a class="p-2 hover:bg-slate-200 hover:rounded" href="/#pricing">Pricing</a>
  </div>
  <div class="basis-1/5 pt-6 space-x-7"></div>
  <div class="basis-1/5 pt-6 space-x-7">
    <a class="p-2 hover:bg-slate-200 hover:rounded" href="/#">Sign in</a>
    <a class="p-3 bg-blue-800 rounded-full text-white hover:bg-blue-600 hover:rounded-full" href="/#">Get started today</a>
  </div>
</nav>
</template>